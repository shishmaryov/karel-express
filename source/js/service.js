window.addEventListener('DOMContentLoaded', () => {
	...
	document.querySelector('.service__button').addEventListener('click', () => {
		if ((document.querySelector('#service__phone').classList.contains('is-invalid')) == true) {
			document.querySelector('.service__phone-wrapper').classList.add('service__phone-wrapper--active');
		} else {
			document.querySelector('.service__phone-wrapper').classList.remove('service__phone-wrapper--active');
