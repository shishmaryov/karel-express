window.addEventListener('DOMContentLoaded', () => {
	...
	validation2
	    ...
	    // if (document.querySelector('#review__ball').value == -1) {
	    // 	document.querySelector('.raiting').classList.add('.is-invalid');
	    // 	return;
	    // } else {
	    ...
	    .onSuccess((event) => {
	        ...
	        submitHandler(document.querySelector('#review__form'));
	    });
	...
	document.getElementById('review__ball').value = -1;
	...
	for (let item of raitingItemsList) {
		item.onclick = () => {
			...
			console.log(document.getElementById('review__ball').value);
		}
	}

	document.querySelector('.review__fieldset').disabled = false;
});
